...
<div class="card">
    ...
    <form>
        <div class="mb-3">
            <label for="idEmployee" class="form-label">Email ou ID de l’employé</label>
            <input type="text" class="form-control" id="idEmployee" placeholder="Ex: jean.martin@entreprise.com">
        </div>
